...
<%
out.println ("<TR><TD>인코딩 방식</TD><TD>" + request.getCharacterEncoding() +
"</TD></TR>");
...
out.println ("<TR><TD>클라이언트 IP 주소</TD><TD>" + request.getRemoteAddr()+
"</TD></TR>");
out.println ("<TR><TD>클라이언트 URL 경로</TD><TD>" + request.getRequestURL()+
"</TD></TR>");
